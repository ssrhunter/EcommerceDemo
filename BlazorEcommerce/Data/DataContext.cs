namespace BlazorEcommerce.Data
{
    public class DataContext : DbContext
    {
        ...
        /// <summary>
        /// For use with database migrations. Run migrations from
        ...
        /// <summary>
        ///  Use the magic of DbContext and entities to return 
        ///  a list of the requested product entities from the DB.
        ///  If the single product ID is passed in using:
        ///  Data = await _context.Products.ToListAsync() get it, 
        ///  or if multiple items are passed in, get them all.
        /// </summary>
